...
print('save figure Training set accuracy')
plt.savefig('fig_trainingAcc' + '.jpg')
...
plt.legend()
plt.show()
print('save figure Training set loss')
plt.savefig('fig_trainingLoss' + '.jpg')
...
def cm_plot(original_label, predict_label, pic=None):
    ...
    plt.ylabel('Ture Labels')  # 坐标轴标签
    plt.xlabel('Predict Labels')  # 坐标轴标签
    plt.title('confusion matrix')
    if pic is not None:
        plt.savefig(str(pic) + '.jpg')
    plt.show()
 
cm_plot(test_label,predict_label,pic='confusion matrix')
#########################